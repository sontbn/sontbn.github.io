...
export default function TodoApp({ onBack, dark, onToggleDark }) {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors duration-300">
      ...
      <header className="sticky top-0 z-10 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 shadow-sm">
        <div className="max-w-lg mx-auto px-4 h-14 flex items-center gap-3">
          <button
            onClick={onBack}
            className="w-9 h-9 rounded-full flex items-center justify-center bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
            aria-label="Back"
          >
          ...
          <div className="flex items-center gap-2 flex-1">
            ...
            <h1 className="text-base font-bold text-gray-800 dark:text-white tracking-tight">My Tasks</h1>
          </div>
          <button
      ...
      <main className="max-w-lg mx-auto px-4 pt-5 pb-24">
        ...
        {visible.length === 0 ? (
          <div className="text-center py-16 text-gray-400 dark:text-gray-600">
            <p className="text-5xl mb-3">{filter === 'Done' ? '🎉' : '📋'}</p>
